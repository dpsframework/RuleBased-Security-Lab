...
|  <img src="images/logoPsBoard.gif" height="60px">   | • lstnPCAP.service<br> • lstnANLZ.service<br> • REresponderPCAP.class<br> • REresponderANLZ.class<br> • nidsDBupdate()  | **Image 3**. An IDS-board agent instance handles the requests received from Reader-Class agents and from Analyzer-Class agents through two Listen Services. Those services use communication interaction protocol with implemented _Rational-Effect_ JADE behaviours.   | 
