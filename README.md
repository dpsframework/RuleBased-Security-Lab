...
|  <img src="images/logoPsNode.gif" height="40px">   | • latestKBASE.service<br> • REinquireKBASE.class<br> • knowledgeBaseRulesLoader()  |  **Image 6**. Every 24 hours Analyzer-Class agents inquires to IDS-board-agent for lastest updated SNORT Rules. If it receives a file as response, the _knowledgeBaseRuleLoader()_ function update its Knowledge-Memory and restart the engine. |
