...
|:--------             |:--------------------- |:---------   |
|  <img src="images/idsboard-01.png" width="170px">   | • nidsDB.service<br> • nidsDB.ShowGrid.class<br> • doPopulate()  | **Image 1**. Board-Class agents can display the log of activities associated with the translation of PCAP files, analyzed files records, alerts found and updated Snort rules. All that information is displayed on the grid, on first tab: "Ticket's repository table".   | 
