...
|  <img src="images/logoPsBoard.gif" height="60px">   | • listenFACTS.service<br> • listenANLZ.service<br> • REresponsePCAP.class<br> • REresponseANLZ.class<br> • nidsDBupdate()  | **Image 3**. An IDS-board agent instance handles the requests received from Reader-Class agents and from Analyzer-Class agents through two Listen Services. Those services use communication interaction protocol with implemented _Rational-Effect_ JADE behaviours.   | 
