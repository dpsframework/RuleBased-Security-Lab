...
|  <img src="images/logoPsMonitorAgent.gif" width="40px">   | • pcap.service<br> • pcap.Watchdog.class<br> • REinformPCAP.class<br> • watingForPCAP()<br> • transformToFacts()  |  **Image 8**. Every 5 minutes Reader-Class agents are looking for new .PCAP files on `./var/pending/` diectory. If they find  a .PCAP file they move it to their own directories, open it and transform to expert system _Facts_ plain text file with `transformToFacts()` function. |
